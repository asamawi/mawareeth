...
calc_patterns = ([
	...
	path('<int:calc_id>/grandFather', calc_views.GrandFatherCreate.as_view(), name='grandFather'),
	path('<int:calc_id>/grandMother', calc_views.GrandMotherCreate.as_view(), name='grandMother'),
	path('<int:calc_id>/sonOfSon', calc_views.SonOfSonCreate.as_view(), name='sonOfSon'),
	path('<int:calc_id>/daughterOfSon', calc_views.DaughterOfSonCreate.as_view(), name='daughterOfSon'),
	path('<int:calc_id>/paternalHalfSister', calc_views.PaternalHalfSisterCreate.as_view(), name='paternalHalfSister'),
	path('<int:calc_id>/paternalHalfBrother', calc_views.PaternalHalfBrotherCreate.as_view(), name='paternalHalfBrother'),
	path('<int:calc_id>/maternalHalfSister', calc_views.MaternalHalfSisterCreate.as_view(), name='maternalHalfSister'),
	path('<int:calc_id>/maternalHalfBrother', calc_views.MaternalHalfBrotherCreate.as_view(), name='maternalHalfBrother'),
	path('<int:calc_id>/sonOfBrother', calc_views.SonOfBrotherCreate.as_view(), name='sonOfBrother'),
	path('<int:calc_id>/sonOfPaternalBrother', calc_views.SonOfPaternalBrotherCreate.as_view(), name='sonOfPaternalBrother'),
	path('<int:calc_id>/uncle', calc_views.UncleCreate.as_view(), name='uncle'),
	path('<int:calc_id>/paternalUncle', calc_views.PaternalUncleCreate.as_view(), name='paternalUncle'),
	path('<int:calc_id>/sonOfUncle', calc_views.SonOfUncleCreate.as_view(), name='sonOfUncle'),
	path('<int:calc_id>/sonOfPaternalUncle', calc_views.SonOfPaternalUncleCreate.as_view(), name='sonOfPaternalUncle'),
    path('<int:pk>/results/', calc_views.ResultsView.as_view(), name='results'),
    path('<int:pk>/new-results/', calc_views.NewResultsView.as_view(), name='new_results'),
