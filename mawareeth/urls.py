...
calc_patterns = ([
	...
	path('<int:calc_id>/paternalSister', calc_views.PaternalSisterCreate.as_view(), name='paternalSister'),
	path('<int:calc_id>/paternalBrother', calc_views.PaternalBrotherCreate.as_view(), name='paternalBrother'),
	path('<int:calc_id>/maternalSister', calc_views.MaternalSisterCreate.as_view(), name='maternalSister'),
	path('<int:calc_id>/maternalBrother', calc_views.MaternalBrotherCreate.as_view(), name='maternalBrother'),
